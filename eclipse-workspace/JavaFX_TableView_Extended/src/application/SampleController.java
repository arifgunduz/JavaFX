...
public class SampleController {
    ...
    void btn_goster_Click(ActionEvent event) {
    	...
    	if(kayitlar_table.getSelectionModel().getSelectedIndex()!=-1) {
    		...
    		System.out.println("SeÃ§ilen KullanÄ±cÄ± adÄ±:"+ kayit.getKul_adi() + "\n" + //
    							"Å�ifre:"+ kayit.getSifre() + "\n" + //
    							"Id:"+ kayit.getId() );
    	}
    	else {
    ...
    void btn_secili_Click(ActionEvent event) {
    	...
    	for(Kayitlar islem: veriler) {
    		if(islem.getOnay().isSelected()) {
    			System.out.println("Secili olan kul:"+ islem.getKul_adi()+ "\n"+ //
    ...
    void initialize() {
    	...
    	veriler.add(new Kayitlar(2,"root", "ferffefe", "Bloke edilmiÅŸ Ã¼ye", butonlar[1]));
    	veriler.add(new Kayitlar(3,"user", "gygyfr6464", "Deneme Yorum iÃ§eriÄŸi", butonlar[2]));
    	...
    	//TableView SÃ¼tunun gorunmez yapma
